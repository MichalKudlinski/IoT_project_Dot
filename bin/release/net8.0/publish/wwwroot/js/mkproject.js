(async function () {
    ...
    $(btnSend).click(async () => {
        ...
        const chatRoomName = document.getElementById("chatroom").value; // Ensure chatRoomName is captured
    ...
    connection.on("ReceiveMessage", (payload) => {
        const { userName, message, chatRoomName, formattedCreatedOn } = payload;
